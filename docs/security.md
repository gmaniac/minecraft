...
- **Security Door** — opens only for the **owner**, an **allowlisted** player, or anyone
  holding a **Keycard**. Others get "Locked".
...
## Device list
- Active: Motion Sensor, Laser Tripwire, Auto Turret, Laser Emitter
- Blocks: Security Camera, Security Monitor, Security Door, Keypad Lock, Floodlight, Alarm Siren, Control Hub
- Item: Keycard
